...
#' @title Deprecated Function
#' @description Load a MATSim linkstats file into memory
#'
...
#' @title Deprecated Function
#' @description Join counts and linkstats to the network, creating a tibble into memory
#'
...
#' @title Deprecated Function
#' @description Categorize daily traffic volume (DTV) and calculate DTV for different link types.
#'
...
#' @title Deprecated Function
#' @description Categorize DTV deviation and aggregate data
#'
...
#'@title Deprecated Function
#' @description Creates a Via-Style scatterplot for each run
#'
#' Takes a tibble from mergeCountsAndLinks.
...
#' @title Deprecated Function
#' @description A function to create symlog scaling for a plot
#'
