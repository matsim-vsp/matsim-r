...
#'
#' @export
readTripsTable <- function(pathToMATSimOutputDirectory = ".", n_max = Inf) {
  options(digits = 18)
  trips_file <- ""
  ...
  if(dir.exists(pathToMATSimOutputDirectory)){
    ...
    trips_file <- pathToMATSimOutputDirectory
  }
...
compareAverageTravelWait <- function(tripsTable1,tripsTable2, unite.columns = character(0), united.name = "united",dump.output.to = matsimDumpOutputDirectory,
  ...
  yaml_list <- list(
    header = list(tab = "Summary", title = "Dashboard", description = "Plots from output directory"),
    layout = list("1" = list(
      title =  paste0("Average Travel/Wait Time Chart from ",attr(tripsTable1,"table_name")," and ",attr(tripsTable2,"table_name")),
      description = "generated by plotAverageTravelWait()",
      type = "bar",
      width = 1,
      props = list(dataset = "averageTravelWait.csv",
...
#  }
  ...
  yaml_list <- list(
    header = list(tab = "Summary", title = "Dashboard", description = "Plots from output directory"),
    layout = list("1" = list(
      title =  paste0("Activity End Times ",attr(tripsTable,"table_name")),
      description = "generated by plotActivityEndTimes()",
      type = "bar",
      width = 1,
      props = list(dataset = "activityEndTimes.csv",
                   x = "dep_time",
                   y = "[n]",
...
#
 # }
  ...
  write.table(tableToWrite,paste0(dump.output.to,"/countDepartureTimesByTime.csv"),row.names = FALSE,sep = ",")

  yaml_list <- list(
    header = list(tab = "Summary", title = "Dashboard", description = "Plots from output directory"),
    layout = list("1" = list(
      title =  paste0("Trip Departure Times per Trip Purpose",attr(tripsTable,"table_name")),
      description = "generated by plotDepartureTimesPerTripPurpose()",
      type = "bar",
      width = 1,
      props = list(dataset = "countDepartureTimesByTime.csv",
                   x = "dep_time",
                   y = "[n]",
